        ...
        <div className="pt-20 container z-[200]">
          <div className="flex flex-col justify-center items-center gap-10">
            <img
              ...
              alt=""
            />
            <div className=" items-center flex flex-wrap justify-center"></div>
            <img
          ...
          <div className="flex justify-center items-center my-12">
            <a
              className="block p-5 bg-[#490004] text-[#d6010f] uppercase rounded-sm text-4xl font-bold border-[#d6010f] border-l-[1rem] border-r-[1rem] border-t-[0.15rem] border-b-[0.15rem]"
              href="#"
              target="_blank"
            >
              Follow The rio line
