  ...
  return (
    <div className="flex flex-col items-center mt-10">
      <div className="w-full p-4 rounded-md">
        <h2 className="text-4xl md:text-5xl lg:text-6xl mb-4 text-shadow-lg text-[#d6010f] font-bold text-center">
