  ...
  return (
    <div className="max-w-[100vw] w-full h-screen overflow-x-hidden relative">
      ...
      <div className="w-full h-full absolute bg-red-700 bg-opacity-50 z-10 top-0">
        ...
        <div className="max-w-[80vw] md:max-w-[60vw] lg:max-w-[40vw]  mx-auto w-full h-full flex items-center flex-col justify-center relative">
          <img
            id="continue-straios"
            src="https://triads.io/assets/_ticker-800fbd73.png"
            alt="image"
          />
          <h3 className={`text-2xl md:text-3xl lg:text-4xl mt-5 text-center text-red-90000`}>
